...
<head>
	...
	<title>Laboratorium Report - <?= ($page['title'] ?? 'Undefined'); ?></title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div>
						<a href="<?php echo base_url(); ?>../admin/expense_categories" target="_blank">Expense Categories</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../admin/expenses" target="_blank">Expenses</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../admin/accounting" target="_blank">Accounting Report</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../admin/doctor_report" target="_blank">Doctor Accounting Report</a>
						<br></br>
					</div>
