...
<head>
	...
	<title>Pharmacy Report - <?= ($page['title'] ?? 'Undefined'); ?></title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- Nav Item - Report -->
			<li class="nav-item">
				<a class="nav-link pb-0" href="<?= site_url($uri = 'report_l'); ?>">
					<i class="fa fa-file"></i>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/closing" target="_blank">Closing Account</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/closing_report" target="_blank">Closing Report</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/all_report" target="_blank">Todays Report</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/todays_sales_report" target="_blank">Sales Report</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/todays_purchase_report" target="_blank">Purchase Report</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/product_sales_reports_date_wise" target="_blank">Sales Report (Medicine Wise)</a>
						<br></br>
						<h3>Profit Loss</h3>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/daily_profit" target="_blank">Invoice Wise Report</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/profit_manufacturer_form" target="_blank">Manufacturer Wise</a>
						<br></br>
						<a href="<?php echo base_url(); ?>../pharmacare/Admin_dashboard/profit_productwise_form" target="_blank">Medicine Wise</a>
						<br></br>
					</div>
